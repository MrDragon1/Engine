...
namespace Ethereal
{
    ...
    void RenderResource::UploadRenderResource(RenderEntity& RenderEntity, RenderMeshData& RenderMeshData) {
        ...
        if (it != m_Mesh_Map.end()) {
            ...
            temp_mesh.m_VertexCount = RenderMeshData.m_static_mesh_data.m_vertex_buffer->m_size / sizeof(QuadVertex);
            ...
            temp_mesh.m_VBO = VertexBuffer::Create(temp_mesh.m_VertexCount * sizeof(QuadVertex));
            temp_mesh.m_VBO->SetLayout(temp_mesh.m_Layout);
            temp_mesh.m_VBO->SetData(RenderMeshData.m_static_mesh_data.m_vertex_buffer->m_data, temp_mesh.m_VertexCount * sizeof(QuadVertex));
    ...
    void RenderResource::UpdateResource(RenderEntity& RenderEntity, RenderMeshData& RenderMeshData) {
        ...
        if (it != m_Mesh_Map.end()) {
            ...
            ET_CORE_ASSERT(mesh.m_VertexCount == RenderMeshData.m_static_mesh_data.m_vertex_buffer->m_size / sizeof(QuadVertex),
            ...
            mesh.m_VBO->SetData(RenderMeshData.m_static_mesh_data.m_vertex_buffer->m_data, mesh.m_VertexCount * sizeof(QuadVertex));
