...
inline static std::unordered_map<std::string, AssetType> s_AssetExtensionMap = {{".EScene", AssetType::Scene},
                                                                                ...
                                                                                {".ttc", AssetType::Font},
                                                                                {".otf", AssetType::Font}};
inline static Ref<Texture> GetAssetIcon(AssetType type) {
    switch (type) {
        case AssetType::Scene:
            return EditorResource::SceneIcon;
        case AssetType::StaticMesh:
            return EditorResource::StaticMeshIcon;
        case AssetType::Material:
            return EditorResource::FileIcon;
        case AssetType::Animation:
            return EditorResource::AnimationIcon;
        case AssetType::Animator:
            return EditorResource::AnimatorIcon;
        case AssetType::Skeleton:
            return EditorResource::SkeletonIcon;
        case AssetType::Mesh:
            return EditorResource::MeshIcon;
        default: {
