...
CLASS(BasicPropertyComponent : public Component, WhiteListFields) {
   ...
   public:
    ...
    BasicPropertyComponent(const std::string& tag) : Tag(tag) {}
    BasicPropertyComponent(const BasicPropertyComponent& other) : Tag(other.Tag) {}
};
...
CLASS(StaticMeshComponent : public Component, WhiteListFields) {
   ...
   public:
    ...
    StaticMeshComponent(const StaticMeshComponent& other) : StaticMeshHandle(other.StaticMeshHandle), MaterialTableRaw(other.MaterialTableRaw) {}
...
CLASS(MeshComponent : public Component, WhiteListFields) {
   ...
   public:
    ...
    MeshComponent(const MeshComponent& other) : MeshHandle(other.MeshHandle) {}
