...
class DriverApi : public RefCounted {
   ...
   public:
    ...
    virtual void DestroyTexture(Ref<Texture> handle) = 0;
    virtual void DestroyRenderTarget(Ref<RenderTarget> handle) = 0;
   ...
   private:
    /*
     * The function below is provided to DriverApi, is used as utilities for functions in public
     * scope above
     */
   private:
};
