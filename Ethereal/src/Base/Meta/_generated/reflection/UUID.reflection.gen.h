...
class TypeUUIDOperator {
   public:
    ...
    static YNode writeByName(void* instance) { return Serializer::write(*(UUID*)instance); }
    // base class
    ...
    static void set_m_UUID(void* instance, void* field_value) { static_cast<UUID*>(instance)->mUUID = *static_cast<uint64_t*>(field_value); }
    static void* get_m_UUID(void* instance) { return static_cast<void*>(&(static_cast<UUID*>(instance)->mUUID)); }
...
void TypeWrapperRegister_UUID() {
    FieldFunctionTuple* f_field_function_tuple_m_UUID = new FieldFunctionTuple(
        &TypeFieldReflectionOparator::TypeUUIDOperator::set_m_UUID, &TypeFieldReflectionOparator::TypeUUIDOperator::get_m_UUID,
        &TypeFieldReflectionOparator::TypeUUIDOperator::getClassName, &TypeFieldReflectionOparator::TypeUUIDOperator::getFieldName_m_UUID,
        &TypeFieldReflectionOparator::TypeUUIDOperator::getFieldTypeName_m_UUID, &TypeFieldReflectionOparator::TypeUUIDOperator::isArray_m_UUID);
    ...
    ClassFunctionTuple* f_class_function_tuple_UUID = new ClassFunctionTuple(
        ...
        &TypeFieldReflectionOparator::TypeUUIDOperator::constructorWithYNode, &TypeFieldReflectionOparator::TypeUUIDOperator::writeByName);
