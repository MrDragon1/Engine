...
YNode Serializer::write(const Transform& instance) {
    YNode ret_context;
    ret_context["position"] = Serializer::write(instance.mPosition);
    ret_context["scale"] = Serializer::write(instance.mScale);
    ret_context["rotation"] = Serializer::write(instance.mRotation);
    return ret_context;
}
template <>
Transform& Serializer::read(const YNode& yaml_context, Transform& instance) {
    ...
    if (!yaml_context["position"].IsNull()) {
        Serializer::read(yaml_context["position"], instance.mPosition);
    }
    if (!yaml_context["scale"].IsNull()) {
        Serializer::read(yaml_context["scale"], instance.mScale);
    }
    if (!yaml_context["rotation"].IsNull()) {
        Serializer::read(yaml_context["rotation"], instance.mRotation);
    }
    return instance;
}
template <>
YNode Serializer::write(const UUID& instance) {
    YNode ret_context;
    ret_context["UUID"] = Serializer::write(instance.mUUID);
    return ret_context;
}
template <>
UUID& Serializer::read(const YNode& yaml_context, UUID& instance) {
    ...
    if (!yaml_context["UUID"].IsNull()) {
        Serializer::read(yaml_context["UUID"], instance.mUUID);
    }
    return instance;
}
template <>
