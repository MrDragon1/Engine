...
// for a method...
//				If this causes any issues in the future we'll just remove these. I thought about renaming the methods, but that doesn't
//really work for DeleteFile, MoveFile or CopyFile 				Seriously, I don't like using undef, but it's just such an annoying situation.
